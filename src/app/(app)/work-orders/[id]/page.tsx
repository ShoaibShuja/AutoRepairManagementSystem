  ...
  return <section className="space-y-8">
    ...
    <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_22rem]">
      <div className="space-y-6">
        ...
        {staff.role !== "technician" && typed.status === "completed" ? <form action={createInvoice}><input name="workOrderId" type="hidden" value={typed.id}/><button className="rounded-md bg-brand-primary px-4 py-2 text-sm font-medium text-brand-primary-foreground">Create invoice</button></form> : null}
