...
import { CalendarDays, CarFront, ClipboardList, LayoutDashboard, ListChecks, Package, UsersRound } from "lucide-react";
...
const navigation: readonly NavigationItem[] = [
  ...
  { href: "/inventory", icon: Package, label: "Inventory", roles: ["admin", "front_desk"] },
